...
<head>
    ...
    <!-- link end  -->
    <!-- website title  -->
    <title>Add Food Item - <?php if($website_name==""){ echo "Website Title";} else{ echo $website_name;} ?></title>
</head>
...
<body>
    ...
    <main class="bg-light">
        <div class="d-flex flex-column align-items-center justify-content-center py-2">
            <div class="bg-light px-2">
                <h2 class="text-muted text-center pt-2">Add Food Item</h2>
                <form autocomplete="off" id="addfooditem-form">
                        ...
                        <div class="col-12 text-center d-flex align-items-center justify-content-center">
                            <div class="form-group py-2">
                                <div class="input-field">
                                    ...
                                    <h5 class="text-muted"><label for="image" class="pointer-event">Upload Food Photo (jpg / jpeg)
                        ...
                        <div class="col-lg-3 col-12">
                            <div class="form-group py-2">
                                <div class="input-field">
                                    ...
                                    <input type="text" name="name" id="name" required placeholder="Enter food name"
                        ...
                        <div class="col-lg-3 col-12">
                            <div class="form-group py-2">
                                <div class="input-field">
                                    ...
                                    <input placeholder="Enter food about" required name="about" type="text" id="about"
                                        class="border border-primary form-control px-3 py-2">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 d-flex justify-content-center align-items-center">
                            <div class="form-group py-2">
                                <div class="input-field text-center">
                                    <button class="btn px-5 btn-outline-warning text-dark bg-warning" id="addfooditem"
                                        type="submit">Add Food Item</button>
                                </div>
                            </div>
                        </div>
                </form>
    ...
    $(document).ready(function() {
        ...
        $("#addfooditem-form").on('submit', function(e) {
            e.preventDefault();
            let addfooditemForm = new FormData(this);

            $.ajax({
                url: "fooditemadded.php",
                type: "POST",
                data: addfooditemForm,
                contentType: false,
                processData: false,
                success: function(data) {
                    if (data == 5) {
                        ...
                        setTimeout(() => {
                            window.location.href = "fooditemadd";
                        }, 2100);
                    }
                }
            });
