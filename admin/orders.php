...
<head>
    ...
    <!-- link end  -->
    <!-- website title  -->
    <title>Delivered Orders - <?php if($website_name==""){ echo "Website Title";} else{ echo $website_name;} ?></title>
</head>
...
<body>
    ...
    <main class="px-2 py-3 overflow-x-scroll">
        <table id="example" class="table table-striped" style="width:100%">
            ...
            <tbody>
                <?php
            $result = mysqli_query($con, "SELECT * from `orders_info` WHERE `statusMessage`='Successful' ORDER BY `id` DESC");
