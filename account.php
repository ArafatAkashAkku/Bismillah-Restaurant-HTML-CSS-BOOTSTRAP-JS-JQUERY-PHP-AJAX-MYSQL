...
<head>
    ...
    <!-- link end  -->
    <!-- website title  -->
    <title>Account Profile - <?php if($website_name==""){ echo "Website Title";} else{ echo $website_name;} ?></title>
</head>
                ...
                <form autocomplete="off" id="accountinfo-form">
                    <div class="row gap-2 d-flex justify-content-center">
                            ...
                            <div class="form-group py-2">
                                <div class="input-field">
                                    ...
                                    <?php
                                            ...
                                            ?>
                                    <img src="images/users/<?php echo htmlentities($row["id"]); ?>/<?php echo htmlentities($row["image"]); ?>"
                        ...
                        <div class="col-md-5 col-12">
                            <div class="form-group py-2">
                                <div class="input-field">
                                    ...
                                    <input type="text" readonly id="email" required
                        ...
                        <div class="col-md-5 col-12">
                            <div class="form-group py-2">
                                <div class="input-field">
                                    ...
                                    <input type="date" id="dob" name="dob" placeholder="Enter your date of birth" value="<?php
                        ...
                        <div class="col-md-5 col-12">
                            <div class="form-group py-2">
                                <div class="input-field">
                                    <h5 class="text-muted"><label for="address">Address (Enter full address)</label>
                                    </h5>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data == 5) {
                        ...
                        Swal.fire({
                            title: "Name or Phone or Address should not be empty",
                            text: "Please try again",
                            icon: "error"
                        });
                    } else if (data == 2) {
                        Swal.fire({
                            title: "Provide full details of Name or Phone or Address",
                            text: "Name > 5 -- Phone == 11 -- Address > 10",
                            icon: "error"
                        });
                    } else if (data == 3) {
                        Swal.fire({
