...
$query = "SELECT * FROM `food_info` WHERE `status`='active' ORDER BY `id` DESC";
...
if ($result) {
    if (mysqli_num_rows($result) > 0) {
        ...
        <div class="card" style="width: 18rem;">
            <img src="images/default/unavailable.jpg" class="card-img-top" alt="images/default/user.jpg"
                loading="lazy">
                <div class="card-body text-center">
                    <h5 class="card-title">No food at this moment</h5>
                    <p class="card-text">Please come again after few hours</p>
                </div>
        </div>';
    }
} 
